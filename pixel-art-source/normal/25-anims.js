// normal/25-anims.js — pixel art (auto-converted from 21×20)
const _ = null
...
/* row  9 */ ['outline', 'accent', 'accent', 'accent', 'accent', 'belly', 'highlight', 'outline', 'accent', 'accent', 'accent', 'outline', 'highlight', 'outline', 'belly', 'belly', 'belly', 'outline', _, _, _],
/* row 10 */ ['outline', 'accent', 'bodyD', 'accent', 'accent', 'accent', 'outline', 'body', 'accent', 'accent', 'accent', 'accent', 'outline', 'highlight', 'outline', 'belly', 'belly', 'outline', _, _, _],
