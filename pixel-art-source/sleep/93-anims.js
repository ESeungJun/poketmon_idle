// haunter-sleep — pixel art (auto-converted from 30×26)
const _ = null
...
/* row 11 */ [_, _, _, _, _, _, _, _, 'outline', 'bodyD', 'body', 'bodyD', 'bodyD', 'shadow', 'shadow', 'shadow', 'shadow', 'bodyD', 'bodyD', 'bodyD', 'bodyD', 'bodyD', 'bodyD', 'bodyD', 'body', 'bodyD', 'bodyD', 'bodyD', 'bodyD', 'outline'],
...
/* row 14 */ [_, 'outline', 'bodyD', 'body', 'shadow', 'shadow', 'shadow', 'outline', 'outline', 'highlight', 'outline', 'bodyD', 'bodyD', 'bodyD', 'bodyD', 'bodyD', 'bodyD', 'bodyD', 'bodyD', 'bodyD', 'bodyD', 'body', 'bodyD', 'bodyD', 'bodyD', 'outline', _, _, _, _],
...
/* row 16 */ ['outline', 'bodyD', 'body', 'shadow', 'bodyD', 'body', 'shadow', 'shadow', 'bodyD', 'outline', _, _, 'body', 'belly', 'belly', 'belly', 'belly', 'body', 'belly', 'belly', 'body', 'bodyD', 'bodyD', 'bodyD', 'body', 'body', 'outline', _, _, _],
