...
/* row  0 */ [_, _, _, '', _, _, ' ', _, ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', _, ' ', ' ', _, _, _, _],
/* row  1 */ [_, _, _, _, _, _, _, _, 'outline', 'outline', 'outline', 'outline', 'outline', 'outline', 'outline', 'outline', _, _, _, _, _, _, _],
/* row  2 */ [_, _, _, _, _, _, _, _, 'outline', 'outline', 'outline', 'outline', 'outline', 'outline', 'outline', 'outline', _, _, _, _, _, _, _],
...
/* row  4 */ [_, _, '', '', 'body', 'body', 'body', 'body', 'highlight', 'highlight', 'highlight', 'highlight', 'highlight', 'highlight', 'highlight', 'highlight', 'body', 'body', 'body', 'body', '', '', _],
...
/* row 21 */ [_, _, '', '', 'outline', 'outline', 'outline', 'outline', 'detail3', 'detail3', 'detail3', 'detail3', 'detail3', 'detail3', 'detail3', 'detail3', 'outline', 'outline', 'outline', 'outline', '', '', _],
