...
export const POKEMON_DB = {
  ...
  bulbasaur: {
    ...
    baseMoves: [
      ...
      { name: '독가루', type: '독', category: '변화', power: null, learnAt: 22 },
      { name: '에너지볼', type: '풀', category: '특수', power: 90, learnAt: 25 },
      { name: '잠자기가루', type: '풀', category: '변화', power: null, learnAt: 39 },
      { name: '솔라빔', type: '풀', category: '특수', power: 120, learnAt: 46 },
    ],
  ...
  ivysaur: {
    ...
    baseMoves: [
      ...
      { name: '씨뿌리기', type: '풀', category: '변화', power: null, learnAt: 7 },
      { name: '독가루', type: '독', category: '변화', power: null, learnAt: 22 },
      { name: '잠자기가루', type: '풀', category: '변화', power: null, learnAt: 32 },
      { name: '기가드레인', type: '풀', category: '특수', power: 75, learnAt: 39 },
      { name: '솔라빔', type: '풀', category: '특수', power: 120, learnAt: 46 },
    ],
    learnableTMs: ['tm06', 'tm11', 'tm17', 'tm18', 'tm44', 'tm53', 'tm87', 'tm90'],
  ...
  venusaur: {
    ...
    baseMoves: [
      ...
      { name: '독가루', type: '독', category: '변화', power: null, learnAt: 22 },
      { name: '잠자기가루', type: '풀', category: '변화', power: null, learnAt: 39 },
      { name: '기가드레인', type: '풀', category: '특수', power: 75, learnAt: 47 },
  ...
  charmeleon: {
    ...
    baseMoves: [
      ...
      { name: '악의파동', type: '악', category: '특수', power: 80, learnAt: 46 },
    ],
  ...
  charizard: {
    ...
    baseMoves: [
      { name: '할퀴기', type: '노말', category: '물리', power: 40, learnAt: 1 },
      { name: '화염방사', type: '불꽃', category: '특수', power: 90, learnAt: 1 },
      { name: '에어슬래시', type: '비행', category: '특수', power: 75, learnAt: 36 },
      { name: '불꽃엄니', type: '불꽃', category: '물리', power: 65, learnAt: 44 },
      { name: '악의파동', type: '악', category: '특수', power: 80, learnAt: 54 },
      { name: '지진', type: '땅', category: '물리', power: 100, learnAt: 60 },
    ],
  ...
  squirtle: {
    ...
    baseMoves: [
      ...
      { name: '조개껍질방어', type: '물', category: '변화', power: null, learnAt: 13 },
  ...
  pidgey: {
    ...
    baseMoves: [
      ...
      { name: '모래공격', type: '땅', category: '변화', power: null, learnAt: 5 },
      { name: '회오리', type: '비행', category: '물리', power: 40, learnAt: 9 },
      { name: '퀵어택', type: '노말', category: '물리', power: 40, learnAt: 13 },
  ...
  pidgeotto: {
    ...
    baseMoves: [
      ...
      { name: '퀵어택', type: '노말', category: '물리', power: 40, learnAt: 21 },
      { name: '회오리', type: '비행', category: '특수', power: 40, learnAt: 28 },
      { name: '에어슬래시', type: '비행', category: '특수', power: 75, learnAt: 36 },
      { name: '모래공격', type: '노말', category: '변화', power: null, learnAt: 44 },
    ],
    learnableTMs: ['tm15', 'tm17', 'tm37', 'tm44', 'tm87', 'tm90'],
  ...
  pidgeot: {
    ...
    baseMoves: [
      ...
      { name: '날개치기', type: '비행', category: '물리', power: 60, learnAt: 1 },
      { name: '퀵어택', type: '노말', category: '물리', power: 40, learnAt: 38 },
      { name: '회오리', type: '비행', category: '특수', power: 40, learnAt: 45 },
      { name: '자화자찬', type: '노말', category: '변화', power: null, learnAt: 55 },
    ],
    learnableTMs: ['tm15', 'tm17', 'tm37', 'tm44', 'tm87', 'tm90'],
    evolveAt: null, evolveTo: null,
  },
  ...
  pikachu: {
    ...
    baseMoves: [
      { name: '전기충격', type: '전기', category: '특수', power: 40, learnAt: 1 },
      { name: '퀵어택', type: '노말', category: '물리', power: 40, learnAt: 13 },
  ...
  raichu: {
    ...
    baseMoves: [
      ...
      { name: '퀵어택', type: '노말', category: '물리', power: 40, learnAt: 1 },
  ...
  gastly: {
    ...
    baseMoves: [
      ...
      { name: '독독', type: '독', category: '변화', power: null, learnAt: 15 },
  ...
  haunter: {
    ...
    baseMoves: [
      ...
      { name: '독독', type: '독', category: '변화', power: null, learnAt: 27 },
  ...
  gengar: {
    ...
    baseMoves: [
      { name: '섀도볼', type: '고스트', category: '특수', power: 80, learnAt: 1 },
      { name: '최면술', type: '에스퍼', category: '변화', power: null, learnAt: 1 },
      { name: '헥스', type: '고스트', category: '특수', power: 65, learnAt: 1 },
      { name: '독독', type: '독', category: '변화', power: null, learnAt: 38 },
      ...
      { name: '통증나누기', type: '노말', category: '변화', power: null, learnAt: 70 },
    ],
  ...
  eevee: {
    ...
    baseMoves: [
      ...
      { name: '베어물기', type: '악', category: '물리', power: 60, learnAt: 9 },
      { name: '귀여운부탁', type: '노말', category: '변화', power: null, learnAt: 17 },
      { name: '보디슬램', type: '노말', category: '물리', power: 85, learnAt: 29 },
    ],
  ...
  snorlax: {
    ...
    baseMoves: [
      { name: '보디슬램', type: '노말', category: '물리', power: 85, learnAt: 1 },
      { name: '잠자기', type: '에스퍼', category: '변화', power: null, learnAt: 1 },
      { name: '고함치기', type: '노말', category: '변화', power: null, learnAt: 17 },
